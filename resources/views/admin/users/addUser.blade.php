        ...
        <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
            <div class="card-body" style="width: 1000px;">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="ten_kh" id="lname" placeholder="Tên khách hàng ">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="sdt" id="lname" placeholder="Số diện thoại">
                    </div>
