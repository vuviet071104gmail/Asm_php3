            ...
            <form action="{{route('article.update',$article)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body" style="width: 1000px;">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            <textarea name="summary" id="summary" cols="30" rows="10">{{ $article->summary }}</textarea>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            ...
                            <img src="{{ asset($article->img) }}" alt="" width="120px">
                        </div>
                        @error('img')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="form-group row mb-3  ">
                        ...
                        <div class="col-sm-9">
                            <select class="form-select " id="category_id" name="category_id">
                                ...
                                <option @if($article->category_id == $id)selected @endif value="{{$id}}">
                                    {{$name}}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            <select class="form-select" id="user_id" name="user_id">
                                ...
                                <option @if($article->user_id == $id)selected @endif
                    ...
                    <div class="form-check form-switch row mb-3 d-flex align-items-center gap-5 w-100">
                        ...
                        <div class="col-sm-9 w-50">
                            <input class="form-check-input " @if( $article->status == 1)
                            checked
                            @endif
                            type="checkbox" name="status" role="switch" id="status" value="1">
                ...
                <div class="border-top">
                    <div class="card-body">
                        ...
                        <a class="btn btn-dark text-light" href="{{route('article.index')}}">Quay trở lại danh sách
                        </a>
